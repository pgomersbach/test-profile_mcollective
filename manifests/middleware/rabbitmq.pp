...
class profile_mcollective::middleware::rabbitmq (
  $confdir                   = '/etc/rabbitmq',
  $vhost                     = $profile_mcollective::params::rabbitmq_vhost,
  ...
  $middleware_port           = $profile_mcollective::params::middleware_port,
  ...
  $middleware_admin_user     = $profile_mcollective::params::middleware_admin_user,
  $middleware_admin_password = $profile_mcollective::params::middleware_admin_password,
